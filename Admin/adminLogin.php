...
<!-- navbar close -->
        <main class=" mt-5 bg-primary banner-backgrond" style="height:90vh">
            <div class="container">
                <div class="row">
                     <div class=" col-md-8 offset-md-2 my-4 text-center text-white"  style="font-size: 30px">
                    <i class="fas fa-strikethrough"></i>
                    <span> Online Service Management System </span>
                    <i class="fas fa-stethoscope"></i>
                    </div>
                    <div class="col-md-4 offset-md-4 mb-5 p-0">
                        <div class="card">
                               ...
                               <?php if(isset($msg)){echo $msg;} ?>
                                <form action="" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="aEmail" required type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="aPassword" required type="password" class="form-control" id="exampleInputPassword1" placeholder="Password">
                                    </div>
