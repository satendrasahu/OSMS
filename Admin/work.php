...
<div class ="col-sm-10 col-md-10 mt-5">
    ...
    <?php
        ...
        {
            echo '
                <table class="table table-borderedless table-hover table-responsive">
                    <thead class="bg-info ">
    ...
    <tbody class="bg-light">';
        ...
        {
            echo '<div class="alert alert-danger" role="alert"> Sry Admin All Work Done, So No data Found ! </div>';
        }
